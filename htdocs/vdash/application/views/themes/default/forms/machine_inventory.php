...
<?php echo $form->get_hidden_field_text(); ?>
	...
	<?php
	$machine_model = $form->get_model('machine_model');
	?>
	<div class="form-group">
		<label class="<?php echo $form->get_layout_data('col-label-width', 'col-sm-2'); ?> control-label"><?php echo lang('app_name'); ?></label>
		<div class="<?php echo $form->get_layout_data('col-field-width', 'col-sm-10'); ?>">
			<input type="text" disabled value="<?php echo htmlentities($machine_model->get_value('machine_default_name')); ?>" class="form-control" />
		</div>
	</div>
<?php
...
?>
	...
	<div class="form-group">
		...
		<div class="<?php echo $form->get_layout_data('col-field-width', 'col-sm-10'); ?>">
			...
			<a href="<?php echo site_url('machine/inventory'); ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i> <?php echo lang('back'); ?></a>
		</div>
	</div>
