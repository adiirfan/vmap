...
<?php echo $form->get_hidden_field_text(); ?>
	...
	<?php
	$app_model = $form->get_model('app_model');
	?>
	<div class="form-group">
		...
		<div class="<?php echo $form->get_layout_data('col-field-width', 'col-sm-10'); ?>">
			<input type="text" disabled value="<?php echo htmlentities($app_model->get_value('app_sys_name')); ?>" class="form-control" />
		</div>
	</div>
<?php
...
?>
	...
	<div class="form-group">
		...
		<div class="<?php echo $form->get_layout_data('col-field-width', 'col-sm-10'); ?>">
			...
			<a href="<?php echo site_url('app/inventory'); ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i> <?php echo lang('back'); ?></a>
		</div>
	</div>
