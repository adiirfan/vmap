...
<form class="form form-inline flexiwidth" role="form" name="<?php echo $form->get_name(); ?>"
...
?>
	<div class="form-group<?php echo $has_error_class; ?>"<?php
	if ( $has_error ) {
		echo ' data-toggle="tooltip" data-container="body" title="' . $form->get_error_message($field_name) . '"';
	}
	?>>
		<label for="<?php echo $field_id; ?>" class="control-label"<?php echo $has_tips_attr; ?>>
			<?php
			if ( $is_required ) {
