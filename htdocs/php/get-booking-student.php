...
$query_book = "SELECT * FROM booking_student left join compstatus on booking_student.computer_name=compstatus.computer_name left join student on student.student_id=booking_student.student_id where booking_student.start_booking >= '$now' and booking_student.end_booking <= '$batas_hari' and expired='0'";
