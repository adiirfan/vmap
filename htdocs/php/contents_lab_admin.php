<?php
											...
											$labname=str_replace("_"," ",$_GET['lab']);
											//echo $labname;
											//echo "select * from booking_lab left join student on student.student_id=booking_lab.student_id where booking_lab.id='$id' and booking_lab.lab_name='$labname'";
								$booked = mysql_query("select * from booking_lab left join student on student.student_id=booking_lab.student_id where booking_lab.id='$id' and booking_lab.lab_name='$labname'");
											if (!$booked) {
										...
										* {
										...
										<!--<![endif]-->
											<div class="wrapper" style="min-width: 320px;background-color: #f2f2f2;" lang="x-wrapper">
											  ...
											  <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000vw - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
												...
												<!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0"><tr class="layout-fixed-width" emb-background-style><td style="width: 600px" class="w560"><![endif]-->
												  <div class="column" style="text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000vw - 173000px);">
											  ...
											  Hi admin,</h2>
											  <br>
											  <h4 align="center">Name : <?php echo  $book['student_name'];   ?> </h4>
											  <h4 align="center">Email : <?php echo  $book['student_email'];   ?> </h4>
											  <h4 align="center">Mobile : <?php echo  $book['student_mobile'];   ?> </h4>
											  <h4 align="center">Agenda : <?php echo  $book['agenda'];   ?> </h4>
											  <h4 align="center">Start date : <?php echo  $book['start_date'];   ?> </h4>
											  <h4 align="center">End date : <?php echo  $book['end_date'];   ?> </h4>
											...
											<div style="Margin-left: 20px;Margin-right: 20px;">
											  ...
											  <p class="size-14" style="Margin-top: 0;Margin-bottom: 0;font-size: 14px;line-height: 21px;" lang="x-size-14">Thanks for booking.<br />
										</p>
											</div>
